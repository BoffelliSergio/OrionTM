        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ConfiguracaoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Campo = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
                    Valor = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SistemaOperacional = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Contato = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Local", x => x.LocalId);
                    table.ForeignKey(
                        name: "FK_Local_Link_LinkId",
                        column: x => x.LinkId,
                        principalTable: "Link",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DNS = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
                    DefaultGateway = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Terminal_Local_LocalId",
                        column: x => x.LocalId,
                        principalTable: "Local",
                        principalColumn: "LocalId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Terminal_Modelo_ModeloId",
                        column: x => x.ModeloId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Terminal_LocalId",
                table: "Terminal",
                column: "LocalId");

            migrationBuilder.CreateIndex(
                name: "IX_Terminal_ModeloId",
                table: "Terminal",
                column: "ModeloId");
        }
